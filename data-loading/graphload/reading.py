...
build the properties" exists once rather than in every stage.

`label_for` records what it did in `Findings` instead of deciding policy: an
override was used, or a name was derived, or the type is unmapped. The stage
decides whether unmapped is fatal.
"""
